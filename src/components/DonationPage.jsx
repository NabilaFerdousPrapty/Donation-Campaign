...
const DonationPage = ({allDonation}) => {
    const {picture,category,description,category_bg,card_bg,text_button_bg,title,price}=allDonation;
   return (
       <div className="">
       ...
       <div className="mt-6 mb-2">
           ...
           <button className="btn rounded-xl" style={{backgroundColor:text_button_bg, opacity:.7}}>View Details</button>
